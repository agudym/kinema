...
if __name__ == "__main__":
    ...
    for model, create_robot in zip(("hexapod", "panda"), (create_hexapod, create_panda)):
        # Clean the BPY scene
        ...
        if model == "hexapod":
            ...
            for frame, angle in zip(frames, angles):
                ...
                link_last.update_transform(target_object.name, T_goal, keyframe_animation=True, frame=frame)
